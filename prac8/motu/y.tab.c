...
{
       0,    49,    49,    50,    53,    54,    58,    61,    64,    64,
      67,    67,    70,    71,    74,    74,    74,    77,    85,    91,
      97,   103,   109,   115,   116,   117,   120,   123,   124,   127,
     127,   127,   128,   128,   128,   131,   132,   135,   136,   139,
     140,   143,   143,   143,   147,   148,   151,   159,   160,   163,
     164
};
#endif
...
{
  "$end", "error", "$undefined", "IF", "INT", "FLOAT", "DOUBLE", "RETURN",
  "MAIN", "VOID", "FOR", "BREAK", "ENDIF", "identifier",
  "integer_constant", "float_constant", "ELSE",
  "modulo_assignment_operator", "multiplication_assignment_operator",
  "division_assignment_operator", "addition_assignment_operator",
  "subtraction_assignment_operator", "assignment_operator",
  "caret_operator", "equality_operator", "inequality_operator",
  ...
  "division_operator", "modulo_operator", "increment_operator",
  "decrement_operator", "';'", "','", "'('", "')'", "$accept", "SS", "S",
  "declaration_list", "variable_declaration", "variable_declaration_list",
  "variable_declaration_identifier", "$@1", "vdi", "type_specifier",
  "expression", "simple_expression", "regular_expression",
  "relational_operators", "sum_expression", "sum_operators", "term",
  "MULOP", "factor", "mutable", "immutable", "constant", YY_NULLPTR
};
#endif
...
{
       6,   -32,   -32,   -32,   -32,   -32,   -32,    -9,     3,   -32,
     -32,   -32,    13,   -10,   -32,    30,   -29,   -19,   -32,    29,
     -32,   -32,   -12,   -32,   -32,   -32,   -14,   -32,   -32,   -32,
     -32,   -32,   -32,   -32,   -32,    -9,   -32,   -32,    -9,   -32,
     -32,   -32,    -9,    -9,    -9,    -9,    -9,    -9,    -9,   -32,
     -32,   -32,     9,   -32,    13,   -29,   -32,   -19,   -32,   -32,
     -32,   -32,   -32,   -32,   -32,    -9,   -32,   -32,   -32
};
...
{
       0,    14,    15,    16,    46,    49,    50,     0,     0,     3,
       4,     6,     0,     0,    25,    26,    28,    36,    40,    45,
      44,    48,     0,     1,     2,    10,     0,     9,     5,    33,
      34,    30,    32,    29,    31,     0,    37,    38,     0,    41,
      42,    43,     0,     0,     0,     0,     0,     0,     0,    23,
      24,    47,    13,     7,     0,    27,    45,    35,    39,    22,
      20,    21,    18,    19,    17,     0,    11,     8,    12
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -32,   -32,    24,   -32,   -32,   -32,   -21,   -32,   -32,   -32,
      -7,   -31,   -32,   -32,     0,   -32,     5,   -32,     2,   -13,
     -32,   -32
};
...
{
      -1,     8,     9,    10,    11,    26,    27,    52,    66,    12,
      13,    14,    15,    35,    16,    38,    17,    42,    18,    19,
      20,    21
};
...
{
      22,    36,    37,    23,     4,     5,     6,     1,     2,     3,
       1,     2,     3,    39,    40,    41,     4,     5,     6,     4,
       5,     6,    56,    53,    54,    56,    25,    28,    51,    56,
       7,    65,    24,    67,    68,    55,    59,    60,    61,    62,
      63,    64,     7,    57,    58,     7,    43,    44,    45,    46,
      47,    48,    56,     0,    29,    30,    31,    32,    33,    34,
       0,     0,     0,     0,    49,    50
};

static const yytype_int8 yycheck[] =
{
       7,    30,    31,     0,    13,    14,    15,     4,     5,     6,
       4,     5,     6,    32,    33,    34,    13,    14,    15,    13,
      14,    15,    35,    37,    38,    38,    13,    37,    40,    42,
      39,    22,     8,    54,    65,    35,    43,    44,    45,    46,
      47,    48,    39,    38,    42,    39,    17,    18,    19,    20,
      21,    22,    65,    -1,    24,    25,    26,    27,    28,    29,
      -1,    -1,    -1,    -1,    35,    36
};
...
{
       0,     4,     5,     6,    13,    14,    15,    39,    42,    43,
      44,    45,    50,    51,    52,    53,    55,    57,    59,    60,
      61,    62,    51,     0,    43,    13,    46,    47,    37,    24,
      25,    26,    27,    28,    29,    54,    30,    31,    56,    32,
      33,    34,    58,    17,    18,    19,    20,    21,    22,    35,
      36,    40,    48,    37,    38,    55,    60,    57,    59,    51,
      51,    51,    51,    51,    51,    22,    49,    47,    52
};
